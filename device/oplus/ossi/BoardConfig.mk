...
BOARD_KERNEL_CMDLINE := androidboot.setinux=permissive
...
# true if u have kernel in boot.img / false if only kernel source
...
BOARD_SYSTEMIMAGE_PARTITION_SIZE := 673603584
...
TARGET_BUILD_PROP += $(DEVICE_PATH)/build.prop
